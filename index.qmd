...
After installing the software, you can open a terminal (you don't need administrative privileges at this point) and run the following command:

git clone `{python} cs['githubHttps']` %userprofile%
